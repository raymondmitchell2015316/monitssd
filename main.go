...
Options:
  ...
  --admin           Start admin web interface.
  --admin-port      Port for admin web interface (default: 8080).
...
func main() {
	...
	adminFlag := flag.Bool("admin", false, "Start admin web interface")
	adminPort := flag.Int("admin-port", 8080, "Port for admin web interface")
	flag.Parse()
